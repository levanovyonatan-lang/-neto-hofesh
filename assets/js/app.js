    ...
    if (type === 'terms') {
        html = `<h2 style="font-size: calc(20px * var(--text-scale, 1)); margin-bottom: 15px; color: #1e293b;">תנאי שימוש והגבלת אחריות</h2>
            <div style="font-size: calc(14px * var(--text-scale, 1)); color: #475569; line-height: 1.6;">
                ...
                <p>4. <b>הגבלת גיל והצטרפות לקהילות:</b> האתר ושירותיו מיועדים למשתמשים בני 13 ומעלה. שימוש באתר על ידי קטינים, ובפרט הצטרפות לקבוצות הוואטסאפ של האתר, מותרת אך ורק באישור, פיקוח ושימוש במכשיר של הורה או אפוטרופוס חוקי.</p>
            </div>`;
