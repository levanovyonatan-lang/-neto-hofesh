...
async function loadDailyTipsDatabase() {
    ...
    const urlParams = new URLSearchParams(window.location.search); const isDemo = urlParams.get('show_demo') === 'true' || window.location.hostname.includes('github.io'); const fileName = isDemo ? 'daily-tips-demo.json' : 'daily-tips.json'; const fetchUrl = window.location.origin + '/assets/data/' + fileName + '?v=10150';
