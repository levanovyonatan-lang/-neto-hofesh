...
function showMainScreen() {
        ...
        if (jobsBanner) {
            ...
            if (jobsLink && jobsImg) {
                if (isAndroid) {
                    ...
                    jobsImg.src = "assets/images/jobs-banner-iphone.jpg?v=5";
                } else {
                    jobsLink.href = "https://chat.whatsapp.com/K9rO1PVtbeK1RbZq8x6HHy?mode=gi_t";
                    jobsImg.src = "assets/images/jobs-banner-android.jpeg?v=5";
                }
            }
        }
    ...
    if (summerHighObj) { summerHighObj.date = new Date('2026-06-19T08:15:00'); }
