...
(function () {
    ...
    function create(container) {
        ...
        function notice(x) {
            if ([1, 6, 8].includes(stage)) return;
            const notices = [
        ...
        function draw() {
            ...
            if (stage === 9) rect(0, 42, width, 218, '#c741400a');
            if (stage === 8) {
            ...
            // Keep the detailed setting softer than the obstacles and player.
            rect(0, 78, width, 192, stage === 10 ? '#cbd8df0a' : '#f4f6ef20');
            ctx.restore();
