...
(function() {
    ...
    function getGameOverMessage(stageIndex, killerEmoji) {
        const msgMap = {
            ...
            '🗑️': "זרקת עטיפה של במבה ופספסת את הפח. נשלחת למנהל. 🗑️",
            ...
            '🌨️': "המזגן על 16. קפאת, עכשיו אתה גוש קרח שמוצג במסדרון. 🌨️",
            ...
            '👮‍♂️': "המאבטח בכניסה לא האמין שאתה לומד פה ולא נתן לך להיכנס. 👮‍♂️",
