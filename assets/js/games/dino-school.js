...
(function() {
    ...
    function getGameOverMessage(stageIndex, killerEmoji) {
        const msgMap = {
            '🚌': "איחרת לאוטובוס, והנהג אפילו לא עשה עצירה של רחמים. 🚌💨",
            '🎒': "התיק שלך שוקל יותר ממך. קרסת תחת הנטל. 🎒",
            '⏰': "הסנוז השביעי היה טעות קריטית. ⏰",
            '📝': "שכחת לכתוב שם ותעודת זהות. אפס נקודות. 📝",
            '📋': "המורה תפסה אותך מעתיק מהדף של השכן. 📋",
            '📚': "מי צריך את כל הספרים האלה?! נמחצת תחת ידע מיותר. 📚",
            '📐': "מי לעזאזל משתמש במד זווית ב-2024? נפסלת. 📐",
            '🗑️': "נפלת לפח. ליטרלי לפח. איזה פדיחות. 🗑️",
            '🪑': "מישהו העיף כיסא בקפיטריה וזה נחת עליך. 🪑",
            '🧹': "השרת העיף אותך יחד עם הלכלוך. 🧹",
            '📦': "ארגז של אוכל פג תוקף נפל עליך. 📦",
            '🗄️': "נתקעת בארונית פתוחה. כואב. 🗄️",
            '🐟': "מאיפה הגיע דג לברזייה של בית ספר?! משרד הבריאות סגר את המקום. 🐟",
            '🌊': "נשטפת בגל של מי ברזייה חמימים ומגעילים. 🌊",
            '💧': "החלקת על שלולית מים. קלאסי. 💧",
            '🚰': "שתית מהברזייה וקיבלת חיידק שלא נודע למדע. 🚰",
            '🪣': "השרת השאיר פה דלי, ועכשיו אתה רטוב עד גרביים. 🪣",
            '🚧': "לא ראית את השלט 'זהירות רטוב'?! 🚧",
            '⚠️': "החלקת. גם הילדים ב-י'2 ראו את זה וצחקו. ⚠️",
            '🏸': "חטפת כדור נוצה ישר לעין. 🏸",
            '🥏': "פריזבי לפרצוף. זה כאב כמו שזה נשמע. 🥏",
            '🏐': "הנחתה מושלמת! חבל שזה היה לראש שלך. 🏐",
            '🎾': "מי משחק טניס בתוך האולם?! 🎾",
            '⚽': "חטפת כדור לפרצוף. הקלאסיקה של שיעור ספורט. ⚽",
            '🏀': "לא תפסת את הכדור, הוא תפס אותך. 🏀",
            '🎳': "איך הגיע לפה כדור באולינג?! ריסקת את האצבע. 🎳",
            '🏋️‍♂️': "ניסית להרים משקולות כדי להרשים. נתפס לך הגב. 🏋️‍♂️",
            '👟': "מישהו זרק עליך נעל מסריחה. התעלפת מהריח. 👟",
            '🦅': "נשר צלל עליך כי חשב שאתה במבה. 🦅",
            '🦇': "עטלף נתקע לך בשיער! איכס! 🦇",
            '🐝': "נעקצת! עכשיו חצי מהפנים שלך מנופחות. 🐝",
            '🦟': "יתוש בגודל של מסוק עקץ אותך. אתה צריך עירוי דם. 🦟",
            '🐍': "זה לא ענף, זה נחש! למה לגעת?! 🐍",
            '🦂': "עקרב נכנס לך לנעל. סוף הטיול שלך הגיע. 🦂",
            '🌵': "נפלת ישר לתוך קקטוס. זה ייקח שעות להוציא הכל. 🌵",
            '🥾': "קיבלת יבלת מטורפת מהנעליים. אי אפשר להמשיך. 🥾",
            '🧪': "ערבבת חומצה עם בסיס. בום. הלך הפוני. 🧪",
            '🦠': "שאפת איזה חיידק מוזר. אחות בית הספר לא תוכל לעזור. 🦠",
            '🛸': "ניסוי בפיזיקה יצא משליטה, נוצר חור שחור. 🛸",
            '⚡': "נגעת בשקע החשמל כדי לראות אם הוא עובד. הוא עובד. ⚡",
            '☄️': "המורה אמרה 'לא לגעת בזה', אז כמובן שנגעת. ☄️",
            '🔬': "הסתכלת במיקרוסקופ ישר לתוך אור מסנוור. עיוורון זמני. 🔬",
            '💥': "פיצוץ במעבדה! אין יותר שיעורי כימיה השנה. 💥",
            '🎵': "שמעת מוזיקה חזק מדי ולא שמעת את המורה מגיעה. 🎵",
            '🎶': "הפלייליסט שלך גרוע מדי, היית חייב להפסיק. 🎶",
            '🎮': "המורה תפסה אותך משחק במקום 'להתכונן למבחן'. 🎮",
            '🌨️': "קפאת במקום. אתה עכשיו פסל קרח במסדרון. 🌨️",
            '🌬️': "רוח פרצים מהמזגן העיפה אותך לכיתה המקבילה. 🌬️",
            '🧊': "קיבלת כוויית קור מהמזגן של כיתה י'3. 🧊",
            '❄️': "שלג בתוך הכיתה?! סבלת מהיפותרמיה. ❄️",
            '🪁': "עפת ברוח כמו עפיפון. 🪁",
            '☔': "מי פותח מטריה בתוך כיתה?! המזל הרע תפס אותך. ☔",
            '🌂': "מרוב קור ניסית להתחבא, אבל קפאת. 🌂",
            '👨‍💼': "המנהל תפס אותך: 'לאיזו כיתה אתה שייך, בחור צעיר?' 👨‍💼",
            '👮‍♂️': "המאבטח חשד שאתה מבריז (והוא צדק). 👮‍♂️",
            '🛑': "לא עצרת בתמרור עצור של תורנות חצר. 🛑",
            '🚨': "הופעלה אזעקה כי רצת במסדרון. נשלחת להשעיה. 🚨",
            '👻': "רוח רפאים הפחידה אותך עד מוות. תרתי משמע. 👻",
            '💀': "מצאת את השלד ממעבדת ביולוגיה זז. ברחת הביתה. 💀",
            '👽': "חייזרים חטפו אותך. תירוץ מעולה לא להכין שיעורים. 👽",
            '🕷️': "עכביש רדיואקטיבי! לצערך לא הפכת לספיידרמן. 🕷️",
            '🦉': "ינשוף הסתכל עליך מבחוץ ב-2 בלילה. קריפי מדי. 🦉",
            '🔦': "השומר האיר עליך עם הפנס. 'מי שם?!' - נתפסת. 🔦",
            '✈️': "החופשה בוטלה, עלית על טיסה לבית ספר למחוננים במקום. ✈️",
            '📓': "עבודת הגשה לקיץ! החופש נהרס רשמית. 📓",
            '👩‍🏫': "המורה תפסה אותך שניה לפני השער ונתנה לך עבודת קיץ. 👩‍🏫",
            '🏫': "הדלת ננעלה! אתה תקוע פה עד ספטמבר. 🏫",
            '🎈': "בלון התפוצץ לך בפרצוף ומרוב בהלה נפסלת. 🎈"
        };
        
        if (killerEmoji && msgMap[killerEmoji]) {
            return msgMap[killerEmoji];
        }
