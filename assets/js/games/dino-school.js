...
(function() {
    ...
    function spawnAsteroid() {
        ...
        el.textContent = String.fromCodePoint(0x2604, 0xFE0F);
        ...
        setTimeout(function() {
            if (el.parentNode) {
                el.textContent = String.fromCodePoint(0x1F4A5);
        ...
        if (spawnTimer <= 0) {
            ...
            if (obstacleQueue.length > 0) {
                ...
                if (stage.flyChance > 0 && randCombo < 0.35) {
                    ...
                    let minGap = Math.max(Math.floor(jumpFrames + 4), 65 - Math.floor(gameSpeed * 2.5) - (diffLevel * 8));
                    let maxGap = minGap + Math.max(3, 14 - diffLevel * 4) + Math.floor(Math.random() * 4);
    ...
    function getGameOverMessage(stageIndex, killerEmoji) {
        const msgMap = {
            '🚌': [
                ...
                "שילמת ברב-קו והוא עשה רעש של 'אין יתרה' מול כל האוטובוס המלא. 🚌",
                "רצת לאוטובוס וכשהגעת הנהג שאל 'לאן אתה חושב שאתה עולה? זה לא מגיע לבית ספר'. 🚌",
                "האוטובוס בלם בפתאומיות ועפת ישר על הילד הכי מקובל בשכבה. 🚌💨",
                "נרדמת באוטובוס והתעוררת בתחנה הסופית כשהנהג צועק עליך לרדת. 🚌"
            ],
            '🎒': [
                ...
                "התיק נפתח לך באמצע המסדרון וכל הפתקים המביכים שלך התפזרו. 🎒",
                "הבאת את התיק הלא נכון ויש בו רק מגבונים לחים ובקבוק של תינוק. 🎒"
            ],
            '⏰': [
                ...
                "קמת ב-6:00 בבוקר, התארגנת, יצאת החוצה... וגילית שיום שבת היום. ⏰"
            ],
            '📝': [
                ...
                "כתבת מבחן שלם בעט מחיק... והמורה השאירה אותו באוטו בשמש. הכל נמחק. 📝",
                "המבחן היה אמריקאי וכל התשובות שיצאו לך היו א'. התחלת להזיע. 📝"
            ],
            '📋': [
                ...
                "הרכזת אמרה 'אני לא כועסת, אני מאוכזבת'. פגיעה ישירה בלב. 📋",
                "תפסו אותך בורח משיעור ספורט. נרשמת לריצת אלפיים כמטלה. 📋"
            ],
            '📚': [
                ...
                "סחבת 8 ספרים רק כדי לגלות שהמורה החליטה ש'היום נלמד מהסיכומים שלי'. 📚",
                "פתחת את הספר ומצאת ציור מביך שציירת בכיתה ג'. כולם ראו. 📚"
            ],
            '📐': [
                "מי לעזאזל משתמש במד זווית מאז כיתה ג'? נפסלת. 📐",
                "דקרת את עצמך בטעות עם המחוגה. קורה לכולם. 📐",
                "ניסית לצייר עיגול מושלם והמחוגה החליקה, עכשיו יש לך חור בדף ובשולחן. 📐"
            ],
            '🗑️': [
                "זרקת עטיפה של במבה ופספסת את הפח. נשלחת למנהל. 🗑️",
                "המורה הכריחה אותך להרים לכלוך שמישהו אחר זרק. 🗑️",
                "ניסית לזרוק כדור נייר לפח ממרחק, פגעת למורה בראש. הלך עליך. 🗑️",
                "התכופפת להרים את העט מהפח ומישהו קרא לך 'ילד פח'. 🗑️"
            ],
            '🪑': [
                "רבת עם מישהו על כיסא כתר בקפיטריה והחלקת. 🪑",
                "ניסית להתנדנד על הכיסא אחורה... ונפלת על הגב. 🪑",
                "בדיוק כשישבת מישהו הזיז לך את הכיסא. התרסקת על הרצפה. 🪑",
                "הכיסא שלך השמיע רעש שנשמע כמו פלוץ בדיוק כשהייתה דממה בכיתה. 🪑",
                "התיישבת על מסטיק משנות ה-90 שמישהו הדביק מתחת לכיסא. 🪑"
            ],
            '🧹': [
                "האב בית עשה ספונג'ה, החלקת על הרטוב מול כולם. 🧹",
                "האב בית ביקש שתעזור לו לטאטא את הכיתה ונשארת בהפסקה. 🧹",
                "לקחו לך את המטאטא כדי לעשות ממנו סטנד לרמקול בהפסקה. 🧹"
            ],
            '📦': [
                "קרטון של טרופיות נפל עליך. עכשיו אתה פשוט דביק. 📦",
                "התחבאת בתוך קרטון בהפסקה, והאב בית זרק אותך למחזור. 📦"
            ],
            ...
            '🚰': [
                ...
                "שתית מהברזייה והרגשת טעם של חלודה וחלומות שבורים. 🚰",
                "מישהו הדביק מסטיק לחור של הברזייה. הושפריץ עליך הכל. 🚰"
            ],
            ...
            '🎾': [
                ...
                "ניסית לחבוט בכדור ופגעת לעצמך בברך עם המחבט. 🎾"
            ],
            '⚽': [
                "הכדורגל של השמיניסטים עף ישר אליך. כואב. ⚽",
                "פספסת בעיטה מול שער ריק בהפסקה. כולם ראו. ⚽",
                "מסרו לך כדור וברחת ממנו מול כל השכבה. ⚽",
                "ניסית לנגוח וקיבלת את הכדור ישר לאף. ⚽"
            ],
            '🏀': [
                "ניסית להטביע והפלסטיק של הסל נשבר עליך. 🏀",
                "מסרו לך כדור חזק מדי והאצבע שלך נשברה לאחור. קלאסי. 🏀",
                "נבחרת אחרון לכוחות בשיעור ספורט. כואב בלב יותר מהמכה. 🏀",
                "הכדור נתקע בין הטבעת ללוח ואף אחד לא הצליח להוציא. 🏀"
            ],
            ...
            '🦅': [
                ...
                "ניסית לעשות סלפי עם ציפור בטיול והיא עשתה עליך את צרכיה. 🦅"
            ],
            '🦇': "נכנסת למערה והערת עטלף. עכשיו אתה בבידוד לכלבת. 🦇",
            '🐝': [
                "דבורה עקצה אותך בטיול. כולם המשיכו ואתה נשארת עם החובש. 🐝",
                "עקצה אותך דבורה בדיוק בשפתיים ועכשיו אתה נראה כמו ברווז. 🐝"
            ],
            '🦟': [
                "יתוש של מצדה מצץ לך את כל הדם בטיול השנתי. 🦟",
                "נעקצת מיתוש בתוך האוזן בלילה באוהל. סיוט. 🦟"
            ],
            '🐍': "שיחקת אותה גבר עם 'נחש חולות', בסוף הכיש אותך צפע. 🐍",
            '🦂': "עקרב נכנס לך לשק שינה. ביי. 🦂",
            '🌵': "הישענת על קקטוס בשביל תמונה לאינסטגרם. עכשיו אתה הקיפוד. 🌵",
            '🥾': "נקרע לך הסנדל שורש. נשארת באוהל עם המורות. 🥾",
            '🧪': [
                "ערבבת אדום עם ירוק. המעבדה התפוצצה. 🧪",
                "שתית בטעות מהכוס של הניסוי כי היית צמא. 🧪",
                "עשית ניסוי עם סודה לשתייה וחומץ, הכל השפריץ למורה על הפרצוף. 🧪"
            ],
            ...
            '🔬': [
                ...
                "המיקרוסקופ היה מלוכלך וזה נראה לך כמו גילוי תא חדש. 🔬"
            ],
            ...
            '👨‍💼': [
                ...
                "המנהל ביקש ממך לבוא אליו למשרד, רעדו לך הברכיים... בסוף הוא רק רצה שתסדר איזה כבל. 👨‍💼"
            ],
            '👮‍♂️': [
            ...
            '👩‍🏫': [
                ...
                "המורה אמרה 'הצלצול הוא בשבילי' ונשארה עוד רבע שעה בכיתה. 👩‍🏫",
                "המורה קראה לך 'חמודי' ליד הקראש שלך. 👩‍🏫",
                "המורה אמרה 'אני אחכה עד שיהיה שקט', ועברו כבר 40 דקות. 👩‍🏫"
            ],
            '🏫': "מרוב שהתרגשת לחופש, רצת לתוך דלת זכוכית. 🏫",
            '🎈': "בלון סיום השנה התפוצץ לך בפרצוף. 🎈",
            '🍎': [
                "המורה תפסה אותך אוכל תפוח בשיעור ואמרה 'הבאת לכולם?'. 🍎",
                "מצאת תולעת בתפוח אבל אחרי שכבר נתת ביס. 🍎",
                "התפוח היה קשה מדי ושברת שן בהפסקה הגדולה. 🍎"
            ],
            '🥪': [
                "הסנדוויץ' של אתמול נשאר בתיק והפך לנשק ביולוגי. 🥪",
                "ניסית להחליף סנדוויץ' וקיבלת לחם עם שוקולד חרובים. 🥪",
                "הסנדוויץ' נפל לך עם הממרח למטה. קלאסי. 🥪"
            ],
            '🧻': [
                "הלכת לשירותים וגילית שאין נייר. המצב אבוד. 🧻",
                "יצאת מהשירותים עם נייר טואלט דבוק לנעל. כולם צחקו. 🧻"
            ]
        };
