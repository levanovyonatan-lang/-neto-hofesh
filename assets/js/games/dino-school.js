...
(function() {
    ...
    const STAGES = [
        /* 0  */ { threshold: 0, title: 'שלב 1: 8:00 בבוקר... למי יש כוח 🥱', bg: 'linear-gradient(to bottom, #bae6fd, #f0f9ff)', gravity: 0.6, jumpForce: -10, flyChance: 0, bonusChance: 0, obsSet: ['🚌', '🎒', '⏰', '☕️'], dinoEmoji: '🦖', dinoFilter: 'none', dinoOpacity: '1' },
        ...
        /* 2  */ { threshold: 240, title: 'שלב 3: מלחמת אוכל בקפיטריה! 🍕', bg: 'linear-gradient(to bottom, #fbcfe8, #fdf2f8)', gravity: 0.6, jumpForce: -10, flyChance: 0, bonusChance: 0.45, bonusSet: ['🍕', '🥪'], obsSet: ['🗑️', '🪑', '🧹', '📦', '🗄️', '🍌'], dinoEmoji: '🦖', dinoFilter: 'drop-shadow(0 2px 5px rgba(251,191,36,0.6))', dinoOpacity: '1', objective: 'תאספו מה שזוהר! 🍕🥪' },
        ...
        /* 7  */ { threshold: 1250, title: 'שלב 8: שיעור חלון! התגנבות יחידים... 🎧', bg: 'linear-gradient(to bottom, #fbcfe8, #f43f5e)', gravity: 0.6, jumpForce: -10, flyChance: 0, bonusChance: 0.5, bonusSet: ['🎧', '📱'], obsSet: ['🎒', '🎵', '🎶', '🎮'], dinoEmoji: '🦖', dinoFilter: 'none', dinoOpacity: '1', objective: 'תאספו מה שזוהר! 🎧📱' },
    ...
    function getGameOverMessage(stageIndex, killerEmoji) {
        const msgMap = {
            ...
            '☕️': "שפכת עליך קפה רותח של בוקר בניסיון נואש להתעורר. ☕️🥵",
            '🍌': "החלקת על קליפת בננה שנשארה על הרצפה מכיתה ג'2. 🍌💨",
            '🧦': "התעלפת מריח של גרב ספורט משומשת שנשארה בלוקר מאז החורף שעבר. 🧦🤢",
            '👠': "נעל עקב מעופפת של המורה להיסטוריה פגעה בך בדיוק במצח. 👠💥"
        };
