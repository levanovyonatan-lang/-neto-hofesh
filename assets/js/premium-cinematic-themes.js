...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown].theme-color {--personal-ink:#ffffff;border:1px solid rgba(255,255,255,0.2) !important;box-shadow:inset 0 0 30px rgba(255,255,255,0.1), 0 15px 40px rgba(0,0,0,0.4) !important;background-color:var(--base-color, #1e293b) !important;overflow:hidden;}
        @keyframes pulseAurora { 0% { transform: scale(1) translate(0, 0) rotate(0deg); } 50% { transform: scale(1.1) translate(2%, -2%) rotate(2deg); } 100% { transform: scale(0.9) translate(-2%, 2%) rotate(-2deg); } }
        #main-timer-bg[data-personal-countdown].theme-color::before {content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 20% 80%, rgba(0,0,0,0.5) 0%, transparent 60%),radial-gradient(circle at 80% 20%, rgba(255,255,255,0.25) 0%, transparent 60%);z-index:0 !important;animation:pulseAurora 12s ease-in-out infinite alternate;pointer-events:none;will-change:transform;transform:translateZ(0);}
        #main-timer-bg[data-personal-countdown].theme-color::after {content:'';position:absolute;inset:0;background:linear-gradient(135deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 40%, rgba(0,0,0,0.5) 100%);z-index:1 !important;pointer-events:none;}
        #main-timer-bg[data-personal-countdown] > :not(canvas) {position:relative;z-index:2;}
        #main-timer-bg[data-personal-countdown]:not([class*="theme-"]) {--personal-ink:#fef08a !important;background:linear-gradient(135deg, #0f172a 0%, #000000 100%) !important;border:1px solid rgba(250,204,21,0.5) !important;box-shadow:inset 0 0 30px rgba(250,204,21,0.15), 0 15px 40px rgba(0,0,0,0.5) !important;overflow:hidden;}
        #main-timer-bg[data-personal-countdown]:not([class*="theme-"])::before {content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 30% 30%, rgba(250,204,21,0.15) 0%, transparent 50%),radial-gradient(circle at 70% 70%, rgba(250,204,21,0.1) 0%, transparent 60%);z-index:0 !important;animation:pulseAurora 15s ease-in-out infinite alternate;pointer-events:none;will-change:transform;transform:translateZ(0);}
        #main-timer-bg[data-personal-countdown]:not([class*="theme-"])::after {content:'';position:absolute;inset:0;background:linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0) 40%, rgba(250,204,21,0.15) 100%);z-index:1 !important;pointer-events:none;}
