...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown].theme-color {--personal-ink:#ffffff;border:1px solid rgba(255,255,255,0.3) !important;box-shadow:inset 0 0 40px rgba(255,255,255,0.2), 0 15px 40px rgba(0,0,0,0.3) !important;}
        #main-timer-bg[data-personal-countdown].theme-color::before {background:linear-gradient(135deg, rgba(255,255,255,0.2) 0%, rgba(255,255,255,0) 50%, rgba(0,0,0,0.3) 100%) !important;backdrop-filter:blur(8px) !important;-webkit-backdrop-filter:blur(8px) !important;}
