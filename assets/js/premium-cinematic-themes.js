...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown]:not([class*="theme-"]) {--personal-ink:#243e35;}
        ...
        #main-timer-bg[data-personal-countdown] :is(#main-target-title,#personal-event-date,#personal-countdown-label,.time-val,.time-lbl,#main-net-days,#net-days-prefix,#net-days-suffix) {color:var(--personal-ink) !important;-webkit-text-fill-color:var(--personal-ink) !important;background:none !important;filter:none !important;text-shadow:none !important;letter-spacing:0 !important;}
