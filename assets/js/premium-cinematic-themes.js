...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown].theme-color {--personal-ink:#fffaf0;border:1px solid rgba(250,204,21,0.4) !important;box-shadow:0 0 35px rgba(250,204,21,0.3),inset 0 0 40px rgba(0,0,0,0.3) !important;}
        #main-timer-bg[data-personal-countdown].theme-color::before {background:linear-gradient(135deg, rgba(9,17,25,0.1) 0%, rgba(9,17,25,0.7) 100%) !important;backdrop-filter:none !important;-webkit-backdrop-filter:none !important;}
