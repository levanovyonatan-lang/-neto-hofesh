...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown].theme-color::before {content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 20% 80%, rgba(0,0,0,0.5) 0%, transparent 60%),radial-gradient(circle at 80% 20%, rgba(255,255,255,0.25) 0%, transparent 60%);z-index:0 !important;animation:pulseAurora 12s ease-in-out infinite alternate;pointer-events:none;}
        ...
        #main-timer-bg[data-personal-countdown]:not([class*="theme-"])::before {content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 30% 30%, rgba(250,204,21,0.15) 0%, transparent 50%),radial-gradient(circle at 70% 70%, rgba(250,204,21,0.1) 0%, transparent 60%);z-index:0 !important;animation:pulseAurora 15s ease-in-out infinite alternate;pointer-events:none;}
