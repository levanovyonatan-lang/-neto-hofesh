...
(function() {
    ...
    celebrationStyle.textContent = `
        ...
        #main-timer-bg[data-personal-countdown].theme-color {--personal-ink:#ffffff;border:1px solid rgba(255,255,255,0.15) !important;box-shadow:inset 0 0 30px rgba(255,255,255,0.1), 0 15px 40px rgba(0,0,0,0.4) !important;background-color:#0b0f19 !important;overflow:hidden;}
        ...
        #main-timer-bg[data-personal-countdown].theme-color::before {content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;background:radial-gradient(circle at 30% 30%, var(--base-color) 0%, transparent 45%),radial-gradient(circle at 70% 70%, var(--base-color) 0%, transparent 50%);opacity:0.55;z-index:0 !important;animation:pulseAurora 12s ease-in-out infinite alternate;backdrop-filter:blur(30px) !important;-webkit-backdrop-filter:blur(30px) !important;}
        #main-timer-bg[data-personal-countdown].theme-color::after {content:'';position:absolute;inset:0;background:linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 40%, rgba(0,0,0,0.6) 100%);z-index:1 !important;pointer-events:none;}
